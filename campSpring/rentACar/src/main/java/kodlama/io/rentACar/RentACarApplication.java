...
public class RentACarApplication {
	...
	public ProblemDetails handeValidationException(MethodArgumentNotValidException methodArgumentNotValidException){ // sen business exception alırsan. Hata kodu döndürmek yerine bu kod  bloğu çalışacak
